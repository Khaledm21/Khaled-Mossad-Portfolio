  ...
  return (
    <div className="relative">
      ...
      <label
        ...
        style={{
          top: isUp ? (textarea ? 10 : 8) : '50%',
          transform: isUp ? 'translateY(0) scale(0.85)' : textarea ? 'translateY(-50%)' : 'translateY(-50%)',
          transformOrigin: 'left center',
          color: focused ? '#6366f1' : 'rgba(148,163,184,0.4)',
          fontSize: isUp ? 11 : 13,
          top: textarea ? (isUp ? 8 : 16) : '50%',
          transform: isUp ? 'translateY(0) scale(0.88)' : 'translateY(-50%)',
        }}
      >
        {label}
      </label>
